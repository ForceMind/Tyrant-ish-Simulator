...
- `quickEngine.js`：快速版参数选择、压缩年份推进、关键选择结算和快速结局。
...
- `render.js`：统一渲染入口。
- `screens/`：官方网站、游戏大厅、年号页、志向页、主游戏、回应、诏令、结局、档案、设置、快速版页面。
...
验证数据规模、事件完整性、8 个年号 120 个月长局模拟、三诏令并行、图鉴写入、官网入口、快速版流程和关键页面渲染。
...
启动 headless Chrome，验证手机/桌面 UI、官网入口、快速版真实点击流程、完整模式真实点击流程、长局浏览器自动游玩、结局写入和图鉴沉淀。
